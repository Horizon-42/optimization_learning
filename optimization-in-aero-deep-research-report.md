...
where $h_k=t_{k+1}-t_k$. This relation is often called a **defect constraint**—meaning the discretized dynamics residual that must be driven to zero. (sources: turn19view0, turn19view1)
